...
# If you don't want any of the advanced features like SSL and binary sending.
# Its good points:
# - No external dependencies (async, etc.)
# - Works with Python2 and Python3
# - Easy clean API
# - Multiple clients
# ===============================================================================
# This version is used by Github Web2Tcp_bridge application.
# Changes of original source:
# - new message "send_message_to_other"
# - extra parameter 'host' in WebsocketServer  
# ===============================================================================
...
class API():
    def run_forever(self):
        try:
            print("Listening at %s on port %d for messages from browser clients ..." % (self.host, self.port))
            self.serve_forever()
    ...
    def send_message_to_other(self, client, msg):
        self._multicast2_(client, msg)
...
class WebsocketServer(ThreadingMixIn, TCPServer, API):
	...
	def _multicast2_(self, exc_client, msg):
		for client in self.clients:
			if client['id'] != exc_client['id']:
				self._unicast_(client, msg)
